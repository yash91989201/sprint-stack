...
This project is indexed by GitNexus as **sprint-stack** (1262 symbols, 2754 relationships, 86 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
...
| Resource | Use for |
|----------|---------|
| `gitnexus://repo/sprint-stack/context` | Codebase overview, check index freshness |
| `gitnexus://repo/sprint-stack/clusters` | All functional areas |
| `gitnexus://repo/sprint-stack/processes` | All execution flows |
| `gitnexus://repo/sprint-stack/process/{name}` | Step-by-step execution trace |
